...
const students1 = [
    ...
    {id:6, name: "박지수", grade : 2, major : "스마트정보통신", avatar : img5},
    ...
    {id:10, name: "스폰지밥", grade : 4, major : "식품생명공학", avatar : "https://tinypic.host/images/2024/11/14/Spongebob.png"}
];
